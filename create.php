...
$sql = "INSERT INTO correspondencia(remitente,destinatario,asunto,tipo,categoria,fecha_recepcion)
VALUES ('$remitente','$destinatario','$asunto','$tipo','$categoria','$fecha_recepcion')";
